...
Tip: Replace the link below with a screenshot of your actual desktop!
...
Warning: This will overwrite your existing config files!
Copy and paste the following block to set up everything at once:
...
Cycle Fan Profiles (Silent/Balanced/Perf)

Fn + ROG Key

Cycle Keyboard RGB Modes
...
(Add screenshots of your "Clean" desktop and "Busy" desktop here)
